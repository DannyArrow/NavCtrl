...
public class ProductFragment extends Fragment {
    ...
    ArrayList<Integer> listOfAllProductsImg;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        listOfAllProductsImg = new ArrayList<Integer>();
        ...
        listOfAllProductsImg.add(R.drawable.laptop);
    ...
    public class VerticalProductAdapter extends RecyclerView.Adapter<ProductFragment.VerticalProductAdapter.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            public ImageView imgagepro;

            public MyViewHolder(View view) {
                super(view);
                textProductName = (TextView) view.findViewById(R.id.textProductName);
                //imgagepro = (ImageView) view.findViewById(R.id.imageView);
        ...
        public void onBindViewHolder(final MyViewHolder holder, int position) {
            ImageView textView = (ImageView) holder.itemView.findViewById(R.id.imageView);
            textView.setImageResource(R.drawable.laptop);
