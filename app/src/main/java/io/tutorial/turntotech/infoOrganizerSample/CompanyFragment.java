...
public class CompanyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        listOfComany.add("Google");
        listOfComany.add("Apple");
        listOfComany.add("Tesla");
        listOfComany.add("Twitter");

        list = new ArrayList<Integer>();
        list.add(R.drawable.imgcompanylogogoogle);
        list.add(R.drawable.imgcompanylogoapple);
        list.add(R.drawable.tesla);
        ...
        recyclerAdapter.Imagelist(list);
    ...
    public class VerticalAdapter extends RecyclerView.Adapter<VerticalAdapter.MyViewHolder> {
        ...
        private List<Integer> verticalList1;
        ...
        public void Imagelist(List<Integer> verticalList1){
            this.verticalList1 = verticalList1;
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            holder.imgview.setImageResource(verticalList1.get(position));
